...
<div class="form-container">
    ...
    <div class="order-form">
        <form>
            ...
            <p>Дата: <input type="text" name="date" readonly value="<?php echo htmlspecialchars($date); ?>"></p>
            <p>Изделие: <input type="text" name="izdelie" readonly value="<?php echo htmlspecialchars($izdelie); ?>"></p>
            <p>Имя файла изображения: <input type="text" readonly name="image" value="<?php echo htmlspecialchars($image); ?>"></p>
            <p>Длина: <input type="text" name="dlina" readonly value="<?php echo htmlspecialchars($dlina); ?>"></p>
            <p>Ширина: <input type="text" name="shirina" readonly value="<?php echo htmlspecialchars($shirina); ?>"></p>
            <p>Высота: <input type="text" name="visota" readonly value="<?php echo htmlspecialchars($visota); ?>"></p>
            <p>Стоимость: <input type="number" step="0.01" name="prise" readonly value="<?php echo htmlspecialchars($prise); ?>"></p>
            <p>Оплата: <input type="number" step="0.01" name="pay" readonly value="<?php echo htmlspecialchars($pay); ?>"></p>
            <p>Процесс выполнения: <textarea name="proces" readonly ><?php echo htmlspecialchars($proces); ?></textarea></p>

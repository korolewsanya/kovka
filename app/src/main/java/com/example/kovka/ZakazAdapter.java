...
public class ZakazAdapter  extends ArrayAdapter<JSONObject> {
    int listLayout;
    ArrayList<JSONObject> usersList;
    Context context;

    public  ZakazAdapter(Context context, int listLayout , int field, ArrayList<JSONObject> usersList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        try{
            ...
            zakaz.setText(usersList.get(position).getString("izdelie"));

...
public class OtherSpecialistsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_other_specialists);

        Bundle arguments = getIntent().getExtras();
        cod = arguments.get("cod").toString();

        TextView textView = findViewById(R.id.tz);
        textView.setText("Тех.задание");
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(getApplicationContext(), OtOtherSpecialistsSaveActivity.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.other_specialists, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch(id) {
            case R.id.ot:
                Intent intent = new Intent(this, OtOtherSpecialistsActivity.class);
                intent.putExtra("cod", cod);
            ...
            case R.id.zad:
                Intent intent3 = new Intent(this, ManagerZadActivity.class);
